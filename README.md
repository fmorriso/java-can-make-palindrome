...
such as the call of canMakePalindrome("racecar"). You should also return true if the string would be a palindrome after
the removal of a single character, such as "raycecar" (remove the 'y') or "abxa" (remove the 'x').
...
```
cd existing_repo
git remote add origin https://gitlab.com/fmorriso/java-can-be-palindrome.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fmorriso/java-can-be-palindrome/-/settings/integrations)
